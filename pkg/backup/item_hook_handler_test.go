...
func (h *mockItemHookHandler) handleHooks(log logger.Interface, groupResource schema.GroupResource, obj runtime.Unstructured, resourceHooks []resourceHook, phase hookPhase) error {
